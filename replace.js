...
const appContent = fs.readFileSync('/Users/abdullahalrashidi/.gemini/antigravity/scratch/whispr/app.js', 'utf8');
const translationsMatch = appContent.match(/(\/\/ --- Constants & Translations ---[\s\S]+?)\/\/ --- App State ---/);
...
const restOfApp = `// --- Supabase Setup ---
...
fs.writeFileSync('/Users/abdullahalrashidi/.gemini/antigravity/scratch/whispr/app.js', translationsBlock + restOfApp);
console.log('App successfully replaced.');
